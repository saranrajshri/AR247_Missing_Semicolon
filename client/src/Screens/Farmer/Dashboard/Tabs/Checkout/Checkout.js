  ...
  return (
    <div id="checkout">
      ...
      <div className="product-summary">
        <div className="card">
          <div className="card-header">{t("summary")}</div>
      ...
      <div className="customer-summary">
        <div className="card">
          <div className="card-header">{t("customer")}</div>
          <div className="card-content">
            <p>
              {t("contact")}:<span>9898989898</span>
            </p>
            <p>
              {t("address")}:<span>123, ABC Street, XYZ City.</span>
            </p>
          </div>
        </div>
      </div>
